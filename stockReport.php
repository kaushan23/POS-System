...
<div class="cont">
    <div class="row">
        <div class="table-responsive" style="padding:10px">
            ...
            <div class="table-responsive" style="padding:10px">
                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Itmes by name.."
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td><a href="editStockReport.php?ID=<?php echo $row["id"]; ?>"><i
                                                class="fi fi-rr-edit"></i></a> <!--/ <a
                                            href="delete_stockReport.php?ID=<//?php echo $row["id"]; ?>"><i
                                                class="fi fi-rr-trash"></i></a>--></td>
                            </tr>
                            <?php
                        }
                    } else {
